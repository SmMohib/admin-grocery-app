...
import 'package:admin_groceryapp/Screens/loading_manager.dart';
import 'package:admin_groceryapp/controllers/MenuController.dart';
import 'package:admin_groceryapp/services/global_method.dart';
import 'package:admin_groceryapp/services/utils.dart';
import 'package:admin_groceryapp/widgets/buttons.dart';
    ...
    return DropdownButtonHideUnderline(
      child: DropdownButton<String>(
        ...
        items: const [
          ...
          DropdownMenuItem<String>(
            child: Text('Girls Collection'),
            value: 'Girls Collection',
          ),
          DropdownMenuItem<String>(
            child: Text('Boys Collection'),
            value: 'Boys Collection',
          ),
          DropdownMenuItem<String>(
            child: Text('Babys Collection'),
            value: 'Babys Collection',
          ),
          DropdownMenuItem<String>(
